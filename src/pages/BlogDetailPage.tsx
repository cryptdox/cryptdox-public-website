...
const BlogDetailPage = () => {
  ...
  return (
    <div>
      <SEOHead 
        title={`${post.title} | AbDox Blog`}
        description={post.content ? post.content.replace(/<[^>]*>/g, '').substring(0, 160) : 'Read the latest insights and updates from AbDox technology experts.'}
